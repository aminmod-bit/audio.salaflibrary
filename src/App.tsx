        ...
        <main className="main-content smooth-transition flex-1">
          <div className="app-container py-6">
            ...
            {currentTab === "admin" && (
              <div className="space-y-8 animate-fade-in">
                <div className="space-y-2">
                  <h1 className="text-[var(--color-text-primary)]">{t("adminTitle")}</h1>
                  <p className="text-xs text-[var(--color-text-secondary)]">Добавляйте и редактируйте лекции в каталоге</p>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  {/* ADD LECTURE FORM */}
                  <div className="p-6 rounded-3xl border border-[var(--color-border)] bg-[var(--color-card)] h-fit">
                    <h2 className="text-base font-bold text-[var(--color-text-primary)] border-b border-white/5 pb-3 mb-4">
                      {t("addLecture")}
                    </h2>

                    <form onSubmit={handleAddAdminLecture} className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          required
                          value={adminTitleRu}
                          onChange={(e) => setAdminTitleRu(e.target.value)}
                          className="w-full bg-white/5 border border-[var(--color-border)] rounded-xl py-2 px-3 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-accent)]"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={adminTitleTg}
                          onChange={(e) => setAdminTitleTg(e.target.value)}
                          className="w-full bg-white/5 border border-[var(--color-border)] rounded-xl py-2 px-3 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-accent)]"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          value={adminScholarId}
                          onChange={(e) => setAdminScholarId(e.target.value)}
                          className="w-full bg-white/5 border border-[var(--color-border)] rounded-xl py-2 px-3 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-accent)]"
                        >
                          {SCHOLARS.map((s) => (
                            <option key={s.id} value={s.id} className="bg-[var(--color-bg)]">
                              {getLocalized(s.name)}
                            </option>
                          ))}
                        </select>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-white/5 border border-[var(--color-border)] rounded-xl py-2 px-3 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-accent)]"
                        >
                          {BOOKS.filter((b) => b.scholarId === adminScholarId).map((b) => (
                            <option key={b.id} value={b.id} className="bg-[var(--color-bg)]">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={adminAudioUrl}
                          placeholder="https://..."
                          onChange={(e) => setAdminAudioUrl(e.target.value)}
                          className="w-full bg-white/5 border border-[var(--color-border)] rounded-xl py-2 px-3 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-accent)]"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          required
                          value={adminDuration}
                          onChange={(e) => setAdminDuration(parseInt(e.target.value) || 0)}
                          className="w-full bg-white/5 border border-[var(--color-border)] rounded-xl py-2 px-3 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-accent)]"
                        />
                      </div>
                      ...
                      <button
                        type="submit"
                        className="w-full bg-[var(--color-accent)] text-black py-2.5 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition active:scale-95"
                      >
                        <Plus size={16} />
                        {t("save")}
                      </button>
                  ...
                  {/* LECTURE MANAGEMENT LIST */}
                  <div className="lg:col-span-2 space-y-4">
                    <h2 className="text-base font-bold text-[var(--color-text-primary)]">
                      {t("allLectures")} ({lectures.length})
                    </h2>

                    {/* Desktop table view */}
                    <div className="hidden md:block overflow-x-auto rounded-3xl border border-[var(--color-border)] bg-[var(--color-card)]">
                      <table className="w-full text-left border-collapse">
                        <thead>
                          <tr className="border-b border-white/5 bg-white/5 text-xs text-[var(--color-text-secondary)] font-bold uppercase tracking-wider">
                            <th className="p-4">{t("lectures")}</th>
                            <th className="p-4">{t("scholars")}</th>
                        ...
                        <tbody className="divide-y divide-white/5">
                          {lectures.map((l) => (
                            <tr key={l.id} className="text-xs text-[var(--color-text-primary)] hover:bg-white/5">
                              <td className="p-4 font-semibold max-w-[220px] truncate">
                                {getLocalized(l.title)}
                                <div className="text-[10px] text-[var(--color-text-secondary)] truncate">
                                  {getLocalized(l.bookName)}
                                </div>
                              </td>
                              <td className="p-4 text-[var(--color-text-secondary)]">
                                {getLocalized(l.scholarName)}
                              </td>
                              <td className="p-4">{formatTime(l.duration)}</td>
                              <td className="p-4 text-center">
                                <button
                                  onClick={() => handleDeleteLecture(l.id)}
                                  className="p-2 text-red-400 hover:text-red-300 rounded-xl hover:bg-red-500/10 transition"
                                >
                                  <Trash2 size={16} />
                                </button>
                              </td>
                    ...
                    {/* Mobile Card view for admin table */}
                    <div className="block md:hidden space-y-3">
                      {lectures.map((l) => (
                        <div
                          key={l.id}
                          className="p-4 rounded-2xl border border-[var(--color-border)] bg-[var(--color-card)] flex flex-col justify-between gap-3"
                        >
                          <div>
                          ...
                          <div className="flex items-center justify-end pt-2.5 border-t border-white/5">
                            <button
                              onClick={() => handleDeleteLecture(l.id)}
                              className="px-3.5 py-1.5 bg-red-500/10 text-red-400 hover:text-red-300 text-xs font-bold rounded-xl flex items-center gap-1.5 transition"
                            >
                              <Trash2 size={14} />
                              {t("delete")}
                            </button>
